...
export default class CreateStory extends Component {
  ...
  async addStory() {
    if (
      ...
      this.state.story &&
      this.state.question1&&this.state.question2&&this.state.question3&&this.state.question4&&this.state.question5&&
      this.state.answer1&&this.state.answer2&&this.state.answer3&&this.state.answer4&&this.state.answer5
